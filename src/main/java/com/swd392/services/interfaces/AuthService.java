...
public interface AuthService {
    ...
    /**
     * Authenticate user with Google ID Token (for Mobile/Android apps)
     * 
     * @param idToken Google ID Token from the mobile app
     * @return Authentication response with JWT token and user info
     */
    AuthenticationResponse authenticateWithGoogleIdToken(String idToken);
